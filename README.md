...
| `oss-readme` | Orders the README so a reader gets the claim, the install command, and a working example before anything else, and links the license, changelog, and contributing guide. |
